...
{/*-Our values section start--**/}
      <div className='text-center'>
        ...
        <h2 className='inter text-4xl font-semibold text-[#101828] py-6'>What we provide in UI/UX</h2>
        <p className='inter text-xl font-normal text-[#667085]'>Our shared values keep us connected and guide us as one team.</p>
      </div>
      ...
      <div className='py-20 flex justify-between  flex-wrap gap-8 '>

{/*--*/}
        <div className='w-96  pb-10 flex  flex-col items-center'>
        <GoPeople  className='text-2xl text-[#FB0029]'/>
